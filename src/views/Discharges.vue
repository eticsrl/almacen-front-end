<template>
    <div>
      <el-card>
        <div class="header">
          ...
          :icon="Plus"
          @click="nuevoEgreso">Nuevo Egreso</el-button>
      </div>
  ...
  import DischargeForm from '@/components/DischargeForm.vue'
  ...
  printDischarge.value = row         // si trae details, lo usa; si no, carga por id
  printId.value = id
